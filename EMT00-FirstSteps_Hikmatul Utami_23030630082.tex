...
\item
  Seperti biasa, * dan / bersifat lebih kuat daripada + atau -. \^{} mengikat lebih kuat dari \emph{, sehingga pi } r \^{} 2 merupakan rumus luas lingkaran.
\item
...
\textgreater sqrt(9*16)

\begin{verbatim}
12
\end{verbatim}

\textgreater B={[}1,2;0,4{]}
...
\textgreater log10(100)

\begin{verbatim}
2
\end{verbatim}

\textgreater sin(45*pi/180)
...
\[i = \sqrt{-1}\]dituliskan dengan huruf I (huruf besar I), namun akan ditampilkan dengan huruf i (i kecil).
...
\textgreater::f:=x\textsuperscript{3-4*x}2+6*x-2
...
\textgreater::diff(f,x)// fungsi turunan
...
\textgreater::df(2);//sebagai contoh,jika x=2
